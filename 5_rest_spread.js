//Rest ...перед параметром в функции - если мы не знаем какое колличество параметров будет принимать функция
//Spread
...
// При клонировение массива например const fib = [1, ...array], 
