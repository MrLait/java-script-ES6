...
//конструктор базвого класса при помощи ключевого слова super(). Наследник получает все поля, методы бащвого класса.
//Методы базового класса можно переобпределять, а чтобы обратиться к базвому функционалу нужно нужно использовать ключевое слова и имя метода super.method()
